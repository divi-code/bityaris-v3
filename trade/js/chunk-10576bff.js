...
function ks() {
  return ["127.0.0.1", "localhost", "", "vercel.app"].indexOf(window.location.hostname) > -1;
}
function Bs(e) {
  return (
...
const Jt = V.isMock(),
  p = {
    ...
    ANNOUNCEMENTS_RECENT: "/phemex-user/public/announcements/recent",
...
const Ei = {
    ...
    ACCOUNT_FEEDBACK: "https://phemex.zendesk.com/hc/en-us/requests/new",
    ...
    PHEMEX_ANNOUNCEMENTS: "/announcements",
    ...
    RECOMMEND_TO_TRADE_USDT:
      "/announcements/recommend-to-trade-usdt-margined-perpetual-contracts",
