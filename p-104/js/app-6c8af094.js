...
var P = ((t) => (
  ...
  (t.WEB3_1000BTC = "/login"),
  (t.WEB3_SOCIAL_TRADE_HOME = "/login"),
  (t.WEB3_SOCIAL_TRADE_EXPLORE_GROUPS = "/login"),
  (t.WEB3_SOCIAL_TRADE_MY_GROUPS = "/login"),
  (t.WEB3_SOCIAL_TRADE_CAST_DETAIL = "/login"),
  (t.WEB3_SOCIAL_TRADE_GROUP_DETAIL = "/login"),
  (t.WEB3_SOCIAL_TRADE_PT_REWARDS = "/login"),
  (t.WEB3_SOCIAL_TRADE_MOBILE_PT_REWARDS = "/login"),
  (t.WEB3_SOCIAL_TRADE_INVITE = "/login"),
  (t.WEB3_SOCIAL_TRADE_INSCRIPTION_MARKETPLACE =
    "/login"),
  (t.WEB3_SOCIAL_TRADE_INSCRIPTION_MARKETPLACE_h5 =
    "/login"),
  (t.WEB3_SOCIAL_TRADE_MY_GROUP_PASS = "/login/"),
  (t.WEB3_SOCIAL_TRADE_GROUP_APPLY_MODERATOR_H5 =
    "/login"),
  (t.WEB3_SOCIAL_TRADE_PULSE_DROP = "/login"),
  (t.WEB3_SOCIAL_TRADE_MOBILE_PULSE_DROP = "/login"),
  (t.WEB3_SOCIAL_TRADE_PULSE_PROFILE = "/login"),
  (t.WEB3_SOCIAL_TRADE_PULSE_PROFILE_EDIT = "/login"),
  (t.WEB3_PULSE_PULSE_ACTIVITY_H5 = "/login"),
  (t.PT_PREHEAT_AIRDROP = "/login"),
